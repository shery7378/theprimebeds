...
class PromoCodeController extends Controller
{
    ...
    public function store(PromoCodeRequest $request)
    {
        ...
        return redirect()
            ->route("back.code.index")
            ->withSuccess(__("New Promo Code Added Successfully."));
    }
    ...
    public function update(PromoCodeRequest $request, PromoCode $code)
    {
        ...
        return redirect()
            ->route("back.code.index")
            ->withSuccess(__("Promo Code Updated Successfully."));
    }
    ...
    public function destroy(PromoCode $code)
    {
        ...
        return redirect()
            ->route("back.code.index")
            ->withSuccess(__("Promo Code Deleted Successfully."));
    }
}
