...
class SubCategoryController extends Controller
{
    ...
    public function index()
    {
        return view("back.subcategory.index", [
            "datas" => Subcategory::with("category")
                ->orderBy("id", "desc")
                ->get(),
        ]);
    }
    ...
    public function store(SubCategoryRequest $request)
    {
        ...
        return redirect()
            ->route("back.subcategory.index")
            ->withSuccess(__("New Subcategory Added Successfully."));
    }
    ...
    public function update(
        ...
        return redirect()
            ->route("back.subcategory.index")
            ->withSuccess(__("Subcategory Updated Successfully."));
    }
    ...
    public function destroy(Subcategory $subcategory)
    {
        ...
        return redirect()
            ->route("back.subcategory.index")
            ->withSuccess(__("Subcategory Deleted Successfully."));
    }
}
