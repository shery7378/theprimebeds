...
use App\{Models\Subscriber, Helpers\EmailHelper, Http\Controllers\Controller};
...
class SubscriberController extends Controller
{
    ...
    public function sendMailSubmit(Request $request)
    {
        ...
        return redirect()
            ->route("back.subscribers.index")
            ->withSuccess(__("Email Sent Successfully."));
    }
    public function delete($id)
    {
        ...
        return redirect()
            ->route("back.subscribers.index")
            ->withSuccess(__("Email Delete Successfully."));
    }
}
