...
class PostController extends Controller
{
    ...
    public function __construct(PostRepository $repository)
    {
        ...
        $this->middleware("permissions:Add Blogs")->only(["create", "store"]);
        $this->middleware("permissions:Update Blogs")->only(["edit", "update"]);
        $this->middleware("permissions:Delete Blogs")->only([
            "destroy",
            "delete",
        ]);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ...
            ->withSuccess(__("New Post Added Successfully."));
    }
