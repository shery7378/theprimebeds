...
class TicketController extends Controller
{
    ...
    public function __construct(TicketRepository $repository)
    {
        ...
        $this->middleware("permissions:Add Tickets")->only(["create", "store"]);
        $this->middleware("permissions:Update Tickets")->only([
            "edit",
            "update",
            "status",
        ]);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route("back.ticket.index")
            ->withSuccess(__("New Ticket Added Successfully."));
    }
    ...
    public function status($id)
    {
        ...
        return redirect()
            ->route("back.ticket.index")
            ->withSuccess(__("Ticket Close Successfully."));
    }
    ...
    public function update(Request $request, Ticket $ticket)
    {
        ...
        return redirect()
            ->back()
            ->withSuccess(__("Ticket Reply Successfully."));
    }
