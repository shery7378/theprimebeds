...
use App\{Models\Role, Http\Controllers\Controller};
...
class RoleController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware("permissions:Add System Users")->only([
            "create",
            "store",
        ]);
        $this->middleware("permissions:Update System Users")->only([
            "edit",
            "update",
        ]);
    ...
    public function store(Request $request)
    {
        ...
        Role::create($input);
        return redirect()
            ->route("back.role.index")
            ->withSuccess(__("New Role Added Successfully."));
    }
