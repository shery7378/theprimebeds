...
class ZenOttomanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Zen Ottoman Bed%')->first();
        if (!$item) {
            echo "Zen Ottoman Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('zen_ottoman.json'));
        ...
        echo "Zen Ottoman Bed fully updated with attributes and images!\n";
    }
}
