...
class LilyBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Lily Bed')->first();
        if (!$item) {
            echo "Lily Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('lily-bed.json'));
        ...
        echo "Lily Bed fully updated with attributes and images!\n";
    }
}
