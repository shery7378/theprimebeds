...
class RaeKidsBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Rae Kids Bed%')->first();
        if (!$item) {
            echo "Rae Kids Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('rae_kids.json'));
        ...
        echo "Rae Kids Bed fully updated with attributes and images!\n";
    }
}
