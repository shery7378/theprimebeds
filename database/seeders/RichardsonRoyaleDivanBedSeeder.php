...
class RichardsonRoyaleDivanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Richardson Royale Divan Bed%')->first();
        if (!$item) {
            echo "Richardson Royale Divan Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('richardson_royale.json'));
        ...
        echo "Richardson Royale Divan Bed fully updated with attributes and images!\n";
    }
}
