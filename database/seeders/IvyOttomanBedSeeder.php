...
class IvyOttomanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Ivy Ottoman Bed%')->first();
        if (!$item) {
            echo "Ivy Ottoman Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('ivy_ottoman.json'));
        ...
        echo "Ivy Ottoman Bed fully updated with attributes and images!\n";
    }
}
