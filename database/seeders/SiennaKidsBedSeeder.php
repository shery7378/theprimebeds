...
class SiennaKidsBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Sienna Kids Bed%')->first();
        if (!$item) {
            echo "Sienna Kids Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('sienna_kids.json'));
        ...
        echo "Sienna Kids Bed fully updated with attributes and images!\n";
    }
}
