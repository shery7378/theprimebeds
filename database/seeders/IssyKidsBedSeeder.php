...
class IssyKidsBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Issy Kids Bed%')->first();
        if (!$item) {
            echo "Issy Kids Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('issy_kids.json'));
        ...
        echo "Issy Kids Bed fully updated with attributes and images!\n";
    }
}
