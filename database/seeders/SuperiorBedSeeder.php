...
class SuperiorBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Superior Bed')->first();
        if (!$item) {
            echo "Superior Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('superior-bed.json'));
        ...
        echo "Superior Bed fully updated with attributes and images!\n";
    }
}
