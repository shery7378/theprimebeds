...
class FlorenceKidsBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Florence Kids Bed%')->first();
        if (!$item) {
            echo "Florence Kids Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('florence_kids.json'));
        ...
        echo "Florence Kids Bed fully updated with attributes and images!\n";
    }
}
