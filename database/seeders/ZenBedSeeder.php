...
class ZenBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Zen Bed')->first();
        if (!$item) {
            echo "Zen Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('zen-bed.json'));
        ...
        echo "Zen Bed fully updated with attributes and images!\n";
    }
}
