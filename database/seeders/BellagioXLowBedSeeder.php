...
class BellagioXLowBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Bellagio-X Bed%Low Sides%')->first();
        if (!$item) {
            echo "Bellagio-X Bed - Low Sides not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('bellagio_x_low.json'));
        ...
        echo "Bellagio-X Bed Low Sides fully updated with attributes and images!\n";
    }
}
