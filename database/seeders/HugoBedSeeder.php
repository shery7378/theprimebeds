...
class HugoBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Hugo Bed%')->first();
        if (!$item) {
            echo "Hugo Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('hugo.json'));
        ...
        echo "Hugo Bed fully updated with attributes and images!\n";
    }
}
