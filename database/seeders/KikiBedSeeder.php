...
class KikiBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Kiki Bed%')->first();
        if (!$item) {
            echo "Kiki Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('kiki.json'));
        ...
        echo "Kiki Bed fully updated with attributes and images!\n";
    }
}
