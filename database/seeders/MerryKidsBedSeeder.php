...
class MerryKidsBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Merry Kids Bed%')->first();
        if (!$item) {
            echo "Merry Kids Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('merry_kids.json'));
        ...
        echo "Merry Kids Bed fully updated with attributes and images!\n";
    }
}
