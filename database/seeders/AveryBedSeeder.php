...
class AveryBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Avery Bed%')->first();
        if (!$item) {
            echo "Avery Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('avery-bed.json'));
        ...
        echo "Avery Bed fully updated with attributes and images!\n";
    }
}
