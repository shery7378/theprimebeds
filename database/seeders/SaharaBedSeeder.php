...
class SaharaBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Sahara Bed')->first();
        if (!$item) {
            echo "Sahara Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('sahara-bed.json'));
        ...
        echo "Sahara Bed fully updated with attributes and images!\n";
    }
}
