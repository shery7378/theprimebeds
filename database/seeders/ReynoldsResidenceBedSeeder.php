...
class ReynoldsResidenceBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Reynolds Residence Bed%')->first();
        if (!$item) {
            echo "Reynolds Residence Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('reynolds-residence-bed.json'));
        ...
        echo "Reynolds Residence Bed fully updated with attributes, images, and correct main photo!\n";
    }
}
