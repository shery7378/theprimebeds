...
class LucianoBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Luciano Bed%')->first();
        if (!$item) {
            echo "Luciano Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('luciano-bed.json'));
        ...
        echo "Luciano Bed fully updated with attributes, images, and correct main photo!\n";
    }
}
