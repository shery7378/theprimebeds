...
class TaraLuxeDivanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Tara Luxe Divan Bed%')->first();
        if (!$item) {
            echo "Tara Luxe Divan Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('tara_luxe.json'));
        ...
        echo "Tara Luxe Divan Bed fully updated with attributes and images!\n";
    }
}
