...
class AmeliaBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Amelia Bed%')->first();
        if (!$item) {
            echo "Amelia Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('amelia-bed.json'));
        ...
        echo "Amelia Bed fully updated with attributes, images, and correct main photo!\n";
    }
}
