...
class AvabelleKidsBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Avabelle Kids Bed%')->first();
        if (!$item) {
            echo "Avabelle Kids Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('avabelle_kids.json'));
        ...
        echo "Avabelle Kids Bed fully updated with attributes and images!\n";
    }
}
