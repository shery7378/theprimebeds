...
class CharlieBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Charlie Bed')->first();
        if (!$item) {
            echo "Charlie Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('charlie-bed.json'));
        ...
        echo "Charlie Bed fully updated with attributes and images!\n";
    }
}
