...
class BellagioDivanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Bellagio Divan Bed%')->first();
        if (!$item) {
            echo "Bellagio Divan Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('bellagio_divan.json'));
        ...
        echo "Bellagio Divan Bed fully updated with attributes and images!\n";
    }
}
