...
class AllureBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Allure Bed%')->first();
        if (!$item) {
            echo "Allure Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('allure.json'));
        ...
        echo "Allure Bed fully updated with attributes and images!\n";
    }
}
