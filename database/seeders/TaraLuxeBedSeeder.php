...
class TaraLuxeBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Tara Luxe Bed%')->first();
        if (!$item) {
            echo "Tara Luxe Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('tara-luxe-bed.json'));
        ...
        echo "Tara Luxe Bed fully updated with attributes, images, and correct main photo!\n";
    }
}
