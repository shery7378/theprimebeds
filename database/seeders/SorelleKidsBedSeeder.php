...
class SorelleKidsBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Sorelle Kids Bed%')->first();
        if (!$item) {
            echo "Sorelle Kids Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('sorelle_kids.json'));
        ...
        echo "Sorelle Kids Bed fully updated with attributes and images!\n";
    }
}
