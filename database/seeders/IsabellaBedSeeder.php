...
class IsabellaBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Isabella Bed%')->first();
        if (!$item) {
            echo "Isabella Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('isabella-bed.json'));
        ...
        echo "Isabella Bed fully updated with attributes, images, and correct main photo!\n";
    }
}
