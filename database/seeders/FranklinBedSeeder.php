...
class FranklinBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Franklin Bed')->first();
        if (!$item) {
            echo "Franklin Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('franklin-bed.json'));
        ...
        echo "Franklin Bed fully updated with attributes and images!\n";
    }
}
