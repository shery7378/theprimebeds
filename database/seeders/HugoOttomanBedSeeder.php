...
class HugoOttomanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Hugo Ottoman Bed%')->first();
        if (!$item) {
            echo "Hugo Ottoman Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('hugo_ottoman.json'));
        ...
        echo "Hugo Ottoman Bed fully updated with attributes and images!\n";
    }
}
