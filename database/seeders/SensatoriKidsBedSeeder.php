...
class SensatoriKidsBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Sensatori Kids Bed%')->first();
        if (!$item) {
            echo "Sensatori Kids Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('sensatori_kids.json'));
        ...
        echo "Sensatori Kids Bed fully updated with attributes and images!\n";
    }
}
