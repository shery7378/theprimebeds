...
class SensatoriOttomanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Sensatori Ottoman Bed%')->first();
        if (!$item) {
            echo "Sensatori Ottoman Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('sensatori_ottoman.json'));
        ...
        echo "Sensatori Ottoman Bed fully updated with attributes and images!\n";
    }
}
