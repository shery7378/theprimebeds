...
class Oxford2000MattressSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Oxford 2000 Mattress (Medium-Firm)')->first();
        if (!$item) {
            echo "Oxford 2000 Mattress (Medium-Firm) not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('oxford-2000-mattress.json'));
        ...
        echo "Oxford 2000 Mattress fully updated with attributes and images!\n";
    }
}
