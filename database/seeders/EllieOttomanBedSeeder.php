...
class EllieOttomanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Ellie Ottoman Bed%')->first();
        if (!$item) {
            echo "Ellie Ottoman Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('ellie-ottoman-bed.json'));
        ...
        echo "Ellie Ottoman Bed fully updated with attributes, images, and correct main photo!\n";
    }
}
?>
