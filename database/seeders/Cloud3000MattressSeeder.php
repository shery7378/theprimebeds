...
class Cloud3000MattressSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Cloud 3000 Mattress (Soft)')->first();
        if (!$item) {
            echo "Cloud 3000 Mattress (Soft) not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('cloud-3000-mattress.json'));
        ...
        echo "Cloud 3000 Mattress fully updated with attributes and images!\n";
    }
}
