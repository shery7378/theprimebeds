...
class IvyBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Ivy Bed%')->first();
        if (!$item) {
            echo "Ivy Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('ivy-bed.json'));
        ...
        echo "Ivy Bed fully updated with attributes and images!\n";
    }
}
