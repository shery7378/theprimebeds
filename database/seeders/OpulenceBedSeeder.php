...
class OpulenceBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Opulence Bed%')->first();
        if (!$item) {
            echo "Opulence Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('opulence.json'));
        ...
        echo "Opulence Bed fully updated with attributes and images!\n";
    }
}
