...
class RosieOttomanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Rosie Ottoman Bed%')->first();
        if (!$item) {
            echo "Rosie Ottoman Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('rosie_ottoman.json'));
        ...
        echo "Rosie Ottoman Bed fully updated with attributes and images!\n";
    }
}
