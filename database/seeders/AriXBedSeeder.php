...
class AriXBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Ari-X Bed')->first();
        if (!$item) {
            echo "Ari-X Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('ari-x-bed.json'));
        ...
        echo "Ari-X Bed fully updated with attributes and images!\n";
    }
}
