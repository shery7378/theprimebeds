...
class LyonHybridBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Lyon Hybrid Bed%')->first();
        if (!$item) {
            echo "Lyon Hybrid Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('lyon-hybrid-bed.json'));
        ...
        echo "Lyon Hybrid Bed fully updated with attributes, images, and correct main photo!\n";
    }
}
