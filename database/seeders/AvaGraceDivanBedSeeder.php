...
class AvaGraceDivanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Ava Grace Divan Bed%')->first();
        if (!$item) {
            echo "Ava Grace Divan Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('ava_grace_divan.json'));
        ...
        echo "Ava Grace Divan Bed fully updated with attributes and images!\n";
    }
}
