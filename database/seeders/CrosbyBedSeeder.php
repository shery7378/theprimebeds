...
class CrosbyBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Crosby Bed%')->first();
        if (!$item) {
            echo "Crosby Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('crosby.json'));
        ...
        echo "Crosby Bed fully updated with attributes and images!\n";
    }
}
