...
class RosieBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Rosie Bed')->first();
        if (!$item) {
            echo "Rosie Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('rosie-bed.json'));
        ...
        echo "Rosie Bed fully updated with attributes and images!\n";
    }
}
