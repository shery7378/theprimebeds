...
class BellagioOttomanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Bellagio Ottoman Bed%')->first();
        if (!$item) {
            echo "Bellagio Ottoman Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('bellagio_ottoman.json'));
        ...
        echo "Bellagio Ottoman Bed fully updated with attributes and images!\n";
    }
}
