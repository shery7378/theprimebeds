...
class SonoSignatureBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Sono Signature Bed%')->first();
        if (!$item) {
            echo "Sono Signature Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('sono_signature.json'));
        ...
        echo "Sono Signature Bed fully updated with attributes and images!\n";
    }
}
