...
class AlexanderKidsBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Alexander Kids Bed%')->first();
        if (!$item) {
            echo "Alexander Kids Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('alexander_kids.json'));
        ...
        echo "Alexander Kids Bed fully updated with attributes and images!\n";
    }
}
