...
class SensatoriHybridBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Sensatori Hybrid Bed%')->first();
        if (!$item) {
            echo "Sensatori Hybrid Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('sensatori_hybrid.json'));
        ...
        echo "Sensatori Hybrid Bed fully updated with attributes and images!\n";
    }
}
