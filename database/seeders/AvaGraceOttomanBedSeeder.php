...
class AvaGraceOttomanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Ava Grace Ottoman Bed%')->first();
        if (!$item) {
            echo "Ava Grace Ottoman Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('ava_grace_ottoman.json'));
        ...
        echo "Ava Grace Ottoman Bed fully updated with attributes and images!\n";
    }
}
