...
class BellagioBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Bellagio Bed%')->first();
        if (!$item) {
            echo "Bellagio Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('bellagio-bed.json'));
        ...
        echo "Bellagio Bed fully updated with attributes, images, and correct main photo!\n";
    }
}
?>
