...
class SensatoriHybridDivanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Sensatori Hybrid Divan Bed%')->first();
        if (!$item) {
            echo "Sensatori Hybrid Divan Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('sensatori_hybrid_divan.json'));
        ...
        echo "Sensatori Hybrid Divan Bed fully updated with attributes and images!\n";
    }
}
