...
class MerrickBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Merrick Bed%')->first();
        if (!$item) {
            echo "Merrick Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('merrick-bed.json'));
        ...
        echo "Merrick Bed fully updated with attributes, images, and correct main photo!\n";
    }
}
?>
