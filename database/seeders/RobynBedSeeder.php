...
class RobynBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Robyn Bed')->first();
        if (!$item) {
            echo "Robyn Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('robyn-bed.json'));
        ...
        echo "Robyn Bed fully updated with attributes and images!\n";
    }
}
