...
class GrantleyBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Grantley Bed%')->first();
        if (!$item) {
            echo "Grantley Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('grantley-bed.json'));
        ...
        echo "Grantley Bed fully updated with attributes, images, and correct main photo!\n";
    }
}
?>
