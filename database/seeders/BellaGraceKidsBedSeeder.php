...
class BellaGraceKidsBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Bella Grace Kids Bed%')->first();
        if (!$item) {
            echo "Bella Grace Kids Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('bella_kids.json'));
        ...
        echo "Bella Grace Kids Bed fully updated with attributes and images!\n";
    }
}
