...
class EllieDivanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Ellie Divan Bed%')->first();
        if (!$item) {
            echo "Ellie Divan Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('ellie_divan.json'));
        ...
        echo "Ellie Divan Bed fully updated with attributes and images!\n";
    }
}
