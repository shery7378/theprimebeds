...
class RoselynKidsBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Roselyn Kids Bed%')->first();
        if (!$item) {
            echo "Roselyn Kids Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('roselyn_kids.json'));
        ...
        echo "Roselyn Kids Bed fully updated with attributes and images!\n";
    }
}
