...
class AmbassadorOttomanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Ambassador Ottoman Bed%')->first();
        if (!$item) {
            echo "Ambassador Ottoman Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('ambassador_ottoman.json'));
        ...
        echo "Ambassador Ottoman Bed fully updated with attributes and images!\n";
    }
}
