...
class ArielBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Ariel Bed%')->first();
        if (!$item) {
            echo "Ariel Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('ariel.json'));
        ...
        echo "Ariel Bed fully updated with attributes and images!\n";
    }
}
