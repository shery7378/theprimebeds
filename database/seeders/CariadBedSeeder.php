...
class CariadBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Cariad Bed')->first();
        if (!$item) {
            echo "Cariad Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('cariad-bed.json'));
        ...
        echo "Cariad Bed fully updated with attributes and images!\n";
    }
}
