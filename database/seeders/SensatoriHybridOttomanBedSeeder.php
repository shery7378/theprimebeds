...
class SensatoriHybridOttomanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Sensatori Hybrid Ottoman Bed%')->first();
        if (!$item) {
            echo "Sensatori Hybrid Ottoman Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('sensatori_hybrid_ottoman.json'));
        ...
        echo "Sensatori Hybrid Ottoman Bed fully updated with attributes and images!\n";
    }
}
