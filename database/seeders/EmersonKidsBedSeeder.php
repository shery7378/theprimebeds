...
class EmersonKidsBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Emerson Kids Bed%')->first();
        if (!$item) {
            echo "Emerson Kids Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('emerson_kids.json'));
        ...
        echo "Emerson Kids Bed fully updated with attributes and images!\n";
    }
}
