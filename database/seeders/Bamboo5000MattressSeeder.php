...
class Bamboo5000MattressSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Bamboo 5000 Mattress (Soft)')->first();
        if (!$item) {
            echo "Bamboo 5000 Mattress (Soft) not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('bamboo-5000-mattress.json'));
        ...
        echo "Bamboo 5000 Mattress fully updated with attributes and images!\n";
    }
}
