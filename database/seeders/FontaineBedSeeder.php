...
class FontaineBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Fontaine Bed%')->first();
        if (!$item) {
            echo "Fontaine Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('fontaine-bed.json'));
        ...
        echo "Fontaine Bed fully updated with attributes, images, and correct main photo!\n";
    }
}
?>
