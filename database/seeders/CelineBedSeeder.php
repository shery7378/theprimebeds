...
class CelineBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Celine Bed')->first();
        if (!$item) {
            echo "Celine Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('celine-bed.json'));
        ...
        echo "Celine Bed fully updated with attributes and images!\n";
    }
}
