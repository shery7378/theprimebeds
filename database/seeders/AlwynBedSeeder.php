...
class AlwynBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Alwyn Bed%')->first();
        if (!$item) {
            echo "Alwyn Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('alwyn-bed.json'));
        ...
        echo "Alwyn Bed fully updated with attributes and images!\n";
    }
}
