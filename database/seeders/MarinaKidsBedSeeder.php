...
class MarinaKidsBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Marina Kids Bed%')->first();
        if (!$item) {
            echo "Marina Kids Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('marina_kids.json'));
        ...
        echo "Marina Kids Bed fully updated with attributes and images!\n";
    }
}
