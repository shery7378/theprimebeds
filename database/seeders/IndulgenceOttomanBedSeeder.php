...
class IndulgenceOttomanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Indulgence Ottoman Bed%')->first();
        if (!$item) {
            echo "Indulgence Ottoman Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('indulgence_ottoman.json'));
        ...
        echo "Indulgence Ottoman Bed fully updated with attributes and images!\n";
    }
}
