...
class LottieBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Lottie Bed')->first();
        if (!$item) {
            echo "Lottie Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('lottie-bed.json'));
        ...
        echo "Lottie Bed fully updated with attributes and images!\n";
    }
}
