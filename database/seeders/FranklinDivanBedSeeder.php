...
class FranklinDivanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Franklin Divan Bed%')->first();
        if (!$item) {
            echo "Franklin Divan Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('franklin_divan.json'));
        ...
        echo "Franklin Divan Bed fully updated with attributes and images!\n";
    }
}
