...
class AlexanderBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Alexander Bed%')->first();
        if (!$item) {
            echo "Alexander Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('alexander.json'));
        ...
        echo "Alexander Bed fully updated with attributes and images!\n";
    }
}
