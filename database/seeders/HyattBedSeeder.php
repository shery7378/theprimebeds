...
class HyattBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Hyatt Bed%')->first();
        if (!$item) {
            echo "Hyatt Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('hyatt-bed.json'));
        ...
        echo "Hyatt Bed fully updated with attributes, images, and correct main photo!\n";
    }
}
?>
