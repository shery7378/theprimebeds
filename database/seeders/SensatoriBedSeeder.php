...
class SensatoriBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Sensatori Bed')->first();
        if (!$item) {
            echo "Sensatori Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('sensatori_bed.json'));
        ...
        echo "Sensatori Bed fully updated with attributes and images!\n";
    }
}
