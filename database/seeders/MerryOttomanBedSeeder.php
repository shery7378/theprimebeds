...
class MerryOttomanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Merry Ottoman Bed%')->first();
        if (!$item) {
            echo "Merry Ottoman Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('merry_ottoman.json'));
        ...
        echo "Merry Ottoman Bed fully updated with attributes and images!\n";
    }
}
