...
class VermontBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Vermont Bed%')->first();
        if (!$item) {
            echo "Vermont Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('vermont-bed.json'));
        ...
        echo "Vermont Bed fully updated with attributes, images, and correct main photo!\n";
    }
}
?>
