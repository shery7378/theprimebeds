...
class DolsieBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Dolsie Bed%')->first();
        if (!$item) {
            echo "Dolsie Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('dolsie.json'));
        ...
        echo "Dolsie Bed fully updated with attributes and images!\n";
    }
}
