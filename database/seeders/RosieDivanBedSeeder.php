...
class RosieDivanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Rosie Divan Bed%')->first();
        if (!$item) {
            echo "Rosie Divan Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('rosie_divan.json'));
        ...
        echo "Rosie Divan Bed fully updated with attributes and images!\n";
    }
}
