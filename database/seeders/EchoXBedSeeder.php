...
class EchoXBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'Echo-X Bed')->first();
        if (!$item) {
            echo "Echo-X Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('echo-x-bed.json'));
        ...
        echo "Echo-X Bed fully updated with attributes and images!\n";
    }
}
