...
class HugoDivanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Hugo Divan Bed%')->first();
        if (!$item) {
            echo "Hugo Divan Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('hugo_divan.json'));
        ...
        echo "Hugo Divan Bed fully updated with attributes and images!\n";
    }
}
