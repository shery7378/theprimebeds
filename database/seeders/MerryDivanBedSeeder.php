...
class MerryDivanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Merry Divan Bed%')->first();
        if (!$item) {
            echo "Merry Divan Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('merry_divan.json'));
        ...
        echo "Merry Divan Bed fully updated with attributes and images!\n";
    }
}
