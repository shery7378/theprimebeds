...
class SensatoriSignatureBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Sensatori Signature Bed%')->first();
        if (!$item) {
            echo "Sensatori Signature Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('sensatori_signature.json'));
        ...
        echo "Sensatori Signature Bed fully updated with attributes and images!\n";
    }
}
