...
class ValenciaBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Valencia Bed%')->first();
        if (!$item) {
            echo "Valencia Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('valencia.json'));
        ...
        echo "Valencia Bed fully updated with attributes and images!\n";
    }
}
