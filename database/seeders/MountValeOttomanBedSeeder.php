...
class MountValeOttomanBedSeeder extends Seeder
{
    public function run(): void
    {
        $item = DB::table('items')->where('name', 'like', '%Mount Vale Ottoman Bed%')->first();
        if (!$item) {
            echo "Mount Vale Ottoman Bed not found.\n";
            return;
        }

        $jsonStr = file_get_contents(base_path('mount_vale_ottoman.json'));
        ...
        echo "Mount Vale Ottoman Bed fully updated with attributes and images!\n";
    }
}
