<ul class="nav">
    ...
    @php
        $decoded = json_decode(Auth::guard('admin')->user()->role->section ?? '', true);
        $section = is_array($decoded) ? $decoded : [];
    @endphp

    @if (array_intersect(['Add Categories', 'Update Categories', 'Delete Categories'], $section))
    <li class="nav-item">
    ...
    @if (array_intersect(['Add Products', 'Update Products', 'Delete Products'], $section))
    <li class="nav-item">
    ...
    @if (array_intersect(['Manage Orders', 'Update Orders', 'Delete Orders'], $section))
    ...
    @if (array_intersect(['Transactions', 'Delete Transactions'], $section))
    <li class="nav-item">
   ...
   @if (array_intersect(['Customer List', 'Update Customers', 'Delete Customers'], $section))
      <li class="nav-item">
    ...
    @if (array_intersect(['Add Tickets', 'Update Tickets', 'Delete Tickets'], $section))
    <li class="nav-item">
    ...
    @if (array_intersect(['Add Site Content', 'Update Site Content', 'Delete Site Content'], $section))
    <li class="nav-item">
    ...
    @if (array_intersect(['Add Faqs', 'Update Faqs', 'Delete Faqs'], $section))
    <li class="nav-item">
    ...
    @if (array_intersect(['Add Blogs', 'Update Blogs', 'Delete Blogs'], $section))
    <li class="nav-item">
    ...
    @if (array_intersect(['Add Pages', 'Update Pages', 'Delete Pages'], $section))
    <li class="nav-item">
    ...
    @if (array_intersect(['Subscribers List', 'Delete Subscribers'], $section))
    <li class="nav-item">
    ...
    @if (array_intersect(['Add System Users', 'Update System Users', 'Delete System Users'], $section))
    <li class="nav-item">
