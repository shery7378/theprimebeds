        ...
        <div class="main-header ">
            ...
            <div class="logo-header">
                ...
                <a href="{{ route('back.dashboard') }}" class="logo">
                    <img src="{{ $setting->logo ? url('assets/img/' . $setting->logo) : url('assets/img/placeholder.png') }}"
                                ...
                                <li>
                                    <div class="user-box">
                                        <div class="avatar-lg"><img
                                                src="{{ Auth::guard('admin')->user()->photo_url }}"
            ...
            <div class="sidebar-wrapper scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-footer text-primary d-block text-center pt-3">
                        <small>Powered by <a href="https://quadtrum.com" target="_blank" class="text-decoration-none fw-semibold text-dark">Quadtrum</a></small>
                    </div>
