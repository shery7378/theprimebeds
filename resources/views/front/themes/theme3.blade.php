    ...
    @if ($extra_settings->is_t3_slider == 1)
        <div  class="hero-area3" >
            ...
            <div class="heroarea-slider owl-carousel">
                ...
                <div class="item" style="background: url('{{ url('assets/img/' . $slider->photo) }}')">
                    <div class="container">
                    <div class="row">
                        ...
                        <div class="layer-4">
                            <div class="right-img">
                            <img class="img-fluid full-img" src="{{ url('assets/img/' . $slider->logo) }}" alt="">
                            </div>
                        </div>
                        </div>
                    </div>
                    ...
                    <a href="{{$banner_third['url1']}}" class="genius-banner">
                        ...
                        <div class="inner-content">
                            ...
                            @if (isset($banner_third['title1']))
                                <h4 style="color:{{ isset($banner_third['title_color1']) && $banner_third['title_color1'] ? $banner_third['title_color1'] : '#fff' }} !important">{{$banner_third['title1']}}</h4>
                            @endif
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{$banner_third['url2']}}" class="genius-banner">
                        ...
                        <div class="inner-content">
                            ...
                            @if (isset($banner_third['title2']))
                                <h4 style="color:{{ isset($banner_third['title_color2']) && $banner_third['title_color2'] ? $banner_third['title_color2'] : '#fff' }} !important">{{$banner_third['title2']}}</h4>
                            @endif
                        </div>
                    </a>
                </div>
