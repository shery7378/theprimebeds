                        ...
                        <form id="checkoutBilling" action="{{ route('front.checkout.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input class="custom-control-input mt-1 " type="checkbox" id="same_address"
                            ...
                            @if ($setting->is_privacy_trams == 1)
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox d-flex align-items-start ">
                                        <input class="custom-control-input mt-1 me-1" type="checkbox" id="trams__condition">
                                        <label class="custom-control-label" for="trams__condition">
                                            This site is protected by reCAPTCHA and the 
                                            <a href="{{ $setting->policy_link }}" target="_blank">Privacy Policy</a> and 
                                            <a href="{{ $setting->terms_link }}" target="_blank">Terms of Service</a> apply.
                                        </label>
                                    </div>
                                </div>
                            @endif
