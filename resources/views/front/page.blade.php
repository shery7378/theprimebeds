...
@section('content')
    ...
    @if(Str::contains(Str::lower($page->slug), ['our-story', 'ourstory', 'about']))
        ...
        <style>
            .story-hero {
                background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('{{ asset('assets/images/about/hero_mountain.png') }}') center 30%/cover no-repeat;
                min-height: 380px;
                display: flex;
                align-items: center;
    ...
    @else
        ...
        <style>
            .default-page-hero {
                background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('{{ asset('assets/images/about/hero_mountain.png') }}') center 30%/cover no-repeat;
                min-height: 280px;
                display: flex;
                align-items: center;
                justify-content: center;
