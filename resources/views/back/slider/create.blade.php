                                ...
                                <ul class="nav nav-pills nav-secondary" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home"
                                            role="tab" aria-controls="pills-home" aria-selected="true">Home Page</a>
                                    </li>
                                    {{-- <li class="nav-item">
                                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile"
                                            role="tab" aria-controls="pills-profile" aria-selected="false">{{ __('Home 2')
                                            }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact"
                                            role="tab" aria-controls="pills-contact" aria-selected="false">{{ __('Home 3')
                                            }}</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="pills-home4-tab" data-toggle="pill" href="#pills-home4"
                                            role="tab" aria-controls="pills-home4" aria-selected="false">{{ __('Home 4')
                                            }}</a>
                                    </li> --}}
                                </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                        ...
                                        <form action="{{ route('back.slider.store') }}" method="POST"
                                            ...
                                            {{-- <div class="form-group">
                                                ...
                                                <br>
                                                <img class="admin-img" src="{{  url('assets/img/placeholder.png') }}"
                                                    alt="No Image Found">
                                                <br>
                                                <span id="change_message" class="mt-1">{{ __('Image Size Should Be 130 x
                                                    40') }}</span>
                                            </div> --}}

                                            {{-- <div class="form-group position-relative">
                                                <label class="file">
                                                    <input type="file" accept="image/*" class="upload-photo" name="logo"
                                            ...
                                            @include('back.components.color_picker', [
                                                'label'   => __('Slider Text Color'),
                                                'name'    => 'text_color',
                                                'id'      => 'slider_text_color',
                                                'forName' => 'slider',
                                                'value'   => old('text_color', '#ffffff'),
                                                'preview' => __('Title / Details Preview')
                                            ])
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span id="chenge_label2"
                                                    class="mt-1">{{ __('Image Size Should Be 968 x 530') }}</span>
                                            </div>
                                        ...
                                        <form action="{{ route('back.slider.store') }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img class="admin-img" src="{{  url('assets/img/placeholder.png') }}"
                                                    alt="No Image Found">
                                                <br>
                                                <span id="chenge_label2" class="mt-1">{{ __('Image Size Should Be 1296 x
                                                    530') }}</span>
                                            </div>
                                        ...
                                        <form action="{{ route('back.slider.store') }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img class="admin-img" src="{{  url('assets/img/placeholder.png') }}"
                                                    alt="No Image Found">
                                                <br>
                                                <span id="change_message" class="mt-1">{{ __('Image Size Should Be 320 x
                                                    320') }}</span>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img class="admin-img" src="{{  url('assets/img/placeholder.png') }}"
                                                    alt="No Image Found">
                                                <br>
                                                <span id="chenge_label2" class="mt-1">{{ __('Image Size Should Be 1903 x
                                                    570') }}</span>
                                            </div>
                                    ...
                                    {{-- <div class="tab-pane fade" id="pills-home4" role="tabpanel"
                                        ...
                                        <form action="{{ route('back.slider.store') }}" method="POST"
                                            ...
                                            <input name="details" type="hidden" id="details" value="theme4"
                                                class="form-control" rows="5" placeholder="{{ __('Enter Details') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img class="admin-img" src="{{  url('assets/img/placeholder.png') }}"
                                                    alt="No Image Found">
                                                <br>
                                                <span id="chenge_label2" class="mt-1">{{ __('Image Size Should Be 1000 x
                                                    530') }}</span>
                                            </div>
