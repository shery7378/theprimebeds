        ...
        <div class="col-xl-10 col-lg-12">
            <div class="card shadow border-0">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form class="admin-form" action="{{ route('back.social.store') }}" method="POST">
                        @csrf

                        {{-- Hidden icon value submitted with the form --}}
                        <input type="hidden" name="icon" id="icon-field" value="{{ old('icon') }}">
                        ...
                        <div class="form-group mt-4">
                            <button type="submit" class="btn btn-secondary px-4">
                                <i class="fas fa-save mr-1"></i> {{ __('Save Social Link') }}
                            </button>
                        </div>
...
(function () {
    ...
    function selectCard(card) {
        ...
        if (key === 'custom') {
            ...
            // Sync whichever sub-type is active
    ...
    /* ---- Pre-select on page load (old() or existing value) ---- */
