    ...
    <tr id="order-bulk-delete">
        ...
        <td>
            <div class="dropdown">
                ...
                <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item" data-toggle="modal" data-target="#statusModal" href="javascript:;"
                        data-href="{{ route('back.order.status', [$data->id, 'order_status', 'Delivered']) }}">{{ __('Deliver') }}</a>
                    <a class="dropdown-item" data-toggle="modal" data-target="#statusModal" href="javascript:;"
        ...
        <td>
            <div class="action-list">
                <a class="btn btn-secondary btn-sm" href="{{ route('back.order.preference', $data->id) }}">
