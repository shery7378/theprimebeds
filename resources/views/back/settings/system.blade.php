                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-3">
                                    <div class="nav flex-column m-3 nav-pills nav-secondary" id="v-pills-tab" role="tablist"
                                        ...
                                        {{-- <a class="nav-link" data-toggle="pill" href="#theme">{{ __('Home Page Themes')
                                            }}</a> --}}
                                        ...
                                        <a class="nav-link" data-toggle="pill" href="#catalog-download">Download Catalog</a>
                                        <a class="nav-link" data-toggle="pill" href="#whatsapp-setup">Setup Whatsapp</a>
                                        <a class="nav-link" data-toggle="pill" href="#setup-header-contact">Setup
                                            Contact</a>
                                    </div>
                                </div>
                                            ...
                                            <div class="tab-content">
                                                <div id="basic" class="tab-pane active"><br>
                                                    <div class="row justify-content-center">
                                                        <div class="col-lg-8">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="title" class="form-control"
                                                                    id="title" placeholder="{{ __('Enter Website Title') }}"
                                                                    value="{{ $setting->title }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-8">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="is_decimal" id="is_decimal"
                                                                    class="form-control">
                                                                    <option value="1" {{ $setting->is_decimal == 1 ? 'selected' : '' }}>
                                                                        On</option>
                                                                    <option value="0" {{ $setting->is_decimal == 0 ? 'selected' : '' }}>
                                                                        Off</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="currency_direction" id="currency_direction"
                                                                    class="form-control">
                                                                    <option value="1" {{ $setting->currency_direction == 1 ? 'selected' : '' }}>
                                                                        {{ __('Left ($100.00)') }}
                                                                    </option>
                                                                    <option value="0" {{ $setting->currency_direction == 0 ? 'selected' : '' }}>
                                                                        {{ __('Right (100.00$)') }}
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="form-group">
                                                                <label for="decimal_separator">{{ __('Decimal Separator') }}
                                                                    *</label>
                                                                <select name="decimal_separator" id="decimal_separator"
                                                                    class="form-control">
                                                                    <option value="," {{ $setting->decimal_separator == ',' ? 'selected' : '' }}>
                                                                        {{ __('Comma (,)') }}
                                                                    </option>
                                                                    <option value="." {{ $setting->decimal_separator == '.' ? 'selected' : '' }}>
                                                                        {{ __('Dot (.)') }}
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="thousand_separator" id="thousand_separator"
                                                                    class="form-control">
                                                                    <option value="," {{ $setting->thousand_separator == ',' ? 'selected' : '' }}>
                                                                        {{ __('Comma (,)') }}
                                                                    </option>
                                                                    <option value="." {{ $setting->thousand_separator == '.' ? 'selected' : '' }}>
                                                                        {{ __('Dot (.)') }}
                                                        ...
                                                        <div class="col-lg-8">
                                                            <div class="form-group">
                                                                <label for="slider-color">{{ __('Slider Text Color') }}
                                                                </label>
                                                                <input type="text" data-jscolor="" name="slider_color"
                                                                    class="form-control" id="slider-color"
                                                                    placeholder="{{ __('Enter Color') }}"
                                                                    value="{{ $setting->slider_color }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        {{-- <div class="col-lg-8">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="theme" id="select_theme">
                                                                    <option value="theme1" {{ $setting->theme == 'theme1' ?
                                                                        'selected' : '' }}>
                                                                        {{ __('Home 1') }}
                                                                    </option>
                                                                    <option value="theme2" {{ $setting->theme == 'theme2' ?
                                                                        'selected' : '' }}>
                                                                        {{ __('Home 2') }}
                                                                    </option>
                                                                    <option value="theme3" {{ $setting->theme == 'theme3' ?
                                                                        'selected' : '' }}>
                                                                        {{ __('Home 3') }}
                                                                    </option>
                                                                    <option value="theme4" {{ $setting->theme == 'theme4' ?
                                                                        'selected' : '' }}>
                                                                        {{ __('Home 4') }}
                                                                    </option>
                                                            ...
                                                            <ul
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link {{ $setting->theme == 'theme1' ? 'active' : '' }}"
                                                                        data-toggle="pill" href="#theme1">{{ __('Home 1')
                                                                        }}</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link {{ $setting->theme == 'theme2' ? 'active' : '' }}"
                                                                        data-toggle="pill" href="#theme2">{{ __('Home 2')
                                                                        }}</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link {{ $setting->theme == 'theme3' ? 'active' : '' }}"
                                                                        data-toggle="pill" href="#theme3">{{ __('Home 3')
                                                                        }}</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link {{ $setting->theme == 'theme4' ? 'active' : '' }}"
                                                                        data-toggle="pill" href="#theme4">{{ __('Home 4')
                                                                        }}</a>
                                                                </li>
                                                            </ul>
                                                                        ...
                                                                        <div class="col-lg-12 ">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12 pb-1">
                                                                                    <img class="admin-setting-img"
                                                                                        src="{{ $setting->logo ? url('assets/img/' . $setting->logo) : url('assets/img/placeholder.png') }}"
                                                                                        alt="No Image Found">
                                                                                </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12 pb-1">
                                                                                    <img class="admin-setting-img my-mw-100"
                                                                                        src="{{ $setting->favicon ? url('assets/img/' . $setting->favicon) : url('assets/img/placeholder.png') }}"
                                                                                        alt="No Image Found">
                                                                                </div>
                                                                    ...
                                                                    <div class="row justify-content-center">
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            <div class="form-group">
                                                                                <label class="switch-primary">
                                                                                    <input type="checkbox"
                                                                                        ...
                                                                                        name="is_loader" value="1" {{ $setting->is_loader == 1 ? 'checked' : '' }}>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12 pb-1">
                                                                                    <img class="admin-setting-img my-mw-100"
                                                                                        src="{{ $setting->loader ? url('assets/img/' . $setting->loader) : url('assets/img/placeholder.png') }}"
                                                                                        alt="No Image Found">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group position-relative ">
                                                    ...
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="col-lg-12 ">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-12 pb-1">
                                                                    <img class="admin-setting-img"
                                                                        src="{{ $setting->meta_image ? url('assets/img/' . $setting->meta_image) : url('assets/img/placeholder.png') }}"
                                                                        alt="No Image Found">
                                                                </div>
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-lg-8">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="custom_css" class="form-control"
                                                                    id="custom_css_area"
                                                                    placeholder="{{ __('Custom Css') }}">{{ $setting->custom_css }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row justify-content-center">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        ...
                                                                        name="is_shop" value="1" {{ $setting->is_shop == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                        ...
                                                        <div class="col-lg-6 offset-lg-3">
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_blog" value="1" {{ $setting->is_blog == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                        ...
                                                        <div class="col-lg-6 offset-lg-3">
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_campaign" value="1" {{ $setting->is_campaign == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                        ...
                                                        <div class="col-lg-6 offset-lg-3">
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_brands" value="1" {{ $setting->is_brands == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                        ...
                                                        <div class="col-lg-6 offset-lg-3">
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status" name="is_faq"
                                                                        value="1" {{ $setting->is_faq == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                        ...
                                                        <div class="col-lg-6 offset-lg-3">
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_contact" value="1" {{ $setting->is_contact == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_google_analytics" value="1" {{ $setting->is_google_analytics == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="google_analytics" class="form-control" id=""
                                                                    placeholder="{{ __('Google Analytics') }}">{{ $setting->google_analytics }}</textarea>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_google_adsense" value="1" {{ $setting->is_google_adsense == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="google_adsense" class="form-control" id=""
                                                                    placeholder="{{ __('Google Adsense Code') }}">{{ $setting->google_adsense }}</textarea>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="recaptcha" value="1" {{ $setting->recaptcha == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_facebook_pixel" value="1" {{ $setting->is_facebook_pixel == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="facebook_pixel" class="form-control" id=""
                                                                    placeholder="{{ __('Facebook Pixel') }}">{{ $setting->facebook_pixel }}</textarea>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_facebook_messenger" value="1" {{ $setting->is_facebook_messenger == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="facebook_messenger" class="form-control"
                                                                    id=""
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_disqus" value="1" {{ $setting->is_disqus == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="disqus" class="form-control" id=""
                                                                    placeholder="{{ __('Disqus Link') }}">{{ $setting->disqus }}</textarea>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_show_category" value="1" {{ $setting->is_show_category == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_attribute_search" value="1" {{ $setting->is_attribute_search == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_range_search" value="1" {{ $setting->is_range_search == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                            ...
                                                            <div class="form-group">
                                                                <label for="view_product">{{ __('View Product') }}
                                                                    *</label>
                                                                <input type="text" name="view_product" class="form-control"
                                                                    id="view_product" placeholder="{{ __('View Product') }}"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="max_price" class="form-control"
                                                                    id="max_price" placeholder="{{ __('Price Range Max') }}"
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_single_checkout" value="1" {{ $setting->is_single_checkout == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_guest_checkout" value="1" {{ $setting->is_guest_checkout == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="is_privacy_trams" value="1" {{ $setting->is_privacy_trams == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                            ...
                                                            <div class="form-group">
                                                                <label for="terms_link">{{ __('Terms of Service Link') }}
                                                                    *</label>
                                                                <input type="text" name="terms_link" class="form-control"
                                                                    id="terms_link"
                                                                    ...
                                                                    <div class="row justify-content-center">
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12 pb-1">
                                                                                    <img class="admin-setting-img"
                                                                                        src="{{ $setting->footer_gateway_img ? url('assets/img/' . $setting->footer_gateway_img) : url('assets/img/placeholder.png') }}"
                                                                                        alt="No Image Found">
                                                                                </div>
                                                ...
                                                <div id="catalog-download" class="tab-pane"><br>
                                                    <div class="row justify-content-center">
                                                        <div class="col-lg-8">
                                                            <div class="mb-3">
                                                                <label for="catalogZip" class="form-label">Upload
                                                                    Catalog (.zip)</label>
                                                                <input class="form-control" type="file" id="catalogZip"
                                                                    name="catalogZip" accept=".zip">
                                                            </div>
                                                        </div>
                                                    ...
                                                    @if(isset($setting->catalog_file))
                                                        <div class="form-group mb-3" style="margin-left:105px">
                                                            <label><strong>Current Uploaded Catalog:</strong></label>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <span>{{ $setting->catalog_file }}</span>
                                                                <a href="{{ asset('files/' . $setting->catalog_file) }}"
                                                    ...
                                                    @else
                                                        <div class="form-group mb-3" style="margin-right:40px">
                                                            <label><strong>Current Uploaded Catalog:</strong></label>
                                                            <p class="text-muted mb-0">No catalog file uploaded.</p>
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="tab-pane" id="whatsapp-setup">
                                                    <div class="card p-4 mb-4 shadow-sm"
                                                        style="box-shadow: 0 0.25rem 0.75rem rgba(128, 128, 128, 0.2);">
                                                        <h5 class="mb-3">WhatsApp Credentials</h5>
                                                        <div class="mb-3">
                                                            <label for="whatsapp" class="form-label">WhatsApp
                                                                Number</label>
                                                            <input type="text" name="whatsapp" id="whatsapp"
                                                                class="form-control" placeholder="e.g. +923001234567"
                                                                value="{{ old('whatsapp', $setting->whatsapp ?? '') }}">
                                                        </div>
                                                    </div>

                                                </div>
                                                {{-- setting up contact info homepage --}}
                                                <div class="tab-pane" id="setup-header-contact">
                                                    <div class="card p-4 mb-4 shadow-sm"
                                                        style="box-shadow: 0 0.25rem 0.75rem rgba(128, 128, 128, 0.2);">
                                                        <h5 class="mb-3">Add Contact Info</h5>
                                                        <div class="mb-3">
                                                            ...
                                                            <label for="contact_mail" class="form-label">Contact
                                                                Email</label>
                                                            <input type="email" name="contact_mail" id="contact_mail"
                                                                class="form-control" placeholder="e.g. +923001234567"
                                                                value="{{ old('contact_mail', $setting->contact_mail ?? '') }}">
                                                        </div>
                                                    </div>
