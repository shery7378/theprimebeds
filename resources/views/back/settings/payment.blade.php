                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img"
                                                                                    src="{{ $cod->photo ? url('assets/img/' . $cod->photo) : url('assets/img/placeholder.png') }}"
                                                                                    alt="No Image Found">
                                                                            </div>
                                                                ...
                                                                <form action="{{ route('back.setting.payment.update') }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img"
                                                                                    src="{{ $stripe->photo ? url('assets/img/' . $stripe->photo) : url('assets/img/placeholder.png') }}"
                                                                ...
                                                                <form action="{{ route('back.setting.payment.update') }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img"
                                                                                    src="{{ $paypal->photo ? url('assets/img/' . $paypal->photo) : url('assets/img/placeholder.png') }}"
                                                                                    alt="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                                        </div>
                                                                ...
                                                                <form action="{{ route('back.setting.payment.update') }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img"
                                                                                    src="{{ $molly->photo ? url('assets/img/' . $molly->photo) : url('assets/img/placeholder.png') }}"
                                                                                    alt="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                                        </div>
                                                                ...
                                                                <form action="{{ route('back.setting.payment.update') }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group col-xl-12">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img"
                                                                                    src="{{ $paytm->photo ? url('assets/img/' . $paytm->photo) : url('assets/img/placeholder.png') }}"
                                                                                    stripe="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                                        </div>
                                                                ...
                                                                <form action="{{ route('back.setting.payment.update') }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group col-xl-12">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img"
                                                                                    src="{{ $sslcommerz->photo ? url('assets/img/' . $sslcommerz->photo) : url('assets/img/placeholder.png') }}"
                                                                                    stripe="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                                        </div>
                                                                ...
                                                                <form action="{{ route('back.setting.payment.update') }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group col-xl-12">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img"
                                                                                    src="{{ $mercadopago->photo ? url('assets/img/' . $mercadopago->photo) : url('assets/img/placeholder.png') }}"
                                                                                    stripe="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                                        </div>
                                                                ...
                                                                <form action="{{ route('back.setting.payment.update') }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group col-xl-12">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img"
                                                                                    src="{{ $authorize->photo ? url('assets/img/' . $authorize->photo) : url('assets/img/placeholder.png') }}"
                                                                                    stripe="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                                        </div>
                                                                ...
                                                                <form action="{{ route('back.setting.payment.update') }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group col-xl-12">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img"
                                                                                    src="{{ $paystack->photo ? url('assets/img/' . $paystack->photo) : url('assets/img/placeholder.png') }}"
                                                                                    stripe="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                                        </div>
                                                                ...
                                                                <form action="{{ route('back.setting.payment.update') }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group col-xl-12">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img"
                                                                                    src="{{ $bank->photo ? url('assets/img/' . $bank->photo) : url('assets/img/placeholder.png') }}"
                                                                                    stripe="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                                        </div>
                                                                ...
                                                                <form action="{{ route('back.setting.payment.update') }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group col-xl-12">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img"
                                                                                    src="{{ $razorpay->photo ? url('assets/img/' . $razorpay->photo) : url('assets/img/placeholder.png') }}"
                                                                                    stripe="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                                        </div>
                                                                ...
                                                                <form action="{{ route('back.setting.payment.update') }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group col-xl-12">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img"
                                                                                    src="{{ $flutterwave->photo ? url('assets/img/' . $flutterwave->photo) : url('assets/img/placeholder.png') }}"
                                                                                    stripe="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                                        </div>
                                                                ...
                                                                <form action="{{ route('back.setting.payment.update') }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group col-xl-12">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img"
                                                                                    src="{{ $paytabs->photo ? url('assets/img/' . $flutterwave->photo) : url('assets/img/placeholder.png') }}"
                                                                                    stripe="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 52 x 35.') }}</span>
                                                                        </div>
