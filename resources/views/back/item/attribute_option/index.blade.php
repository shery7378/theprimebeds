            ...
            <div class="card-body">
                <div class="d-sm-flex align-items-center justify-content-between">
                    ...
                    <div>
                        ...
                        <a class="btn btn-primary btn-sm" href="{{ route('back.option.create', $item->id) }}"><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ __('You are going to delete this option. All contents related with this option will be lost.') }}
