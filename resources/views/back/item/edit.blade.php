        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <img class="admin-img lg" src="{{ $item->photo ? url('assets/img/'.$item->photo) : url('assets/img/placeholder.png') }}" >
                    </div>
                            ...
                            <div class="d-block gallery_image_view">
                                ...
                                @forelse($item->galleries as $gallery)
                                    <div class="single-g-item d-inline-block m-2">
                                            ...
                                            <a class="popup-link" href="{{ $gallery->photo ? url('assets/img/'.$gallery->photo) : url('assets/img/placeholder.png') }}">
                                                <img class="admin-gallery-img" src="{{ $gallery->photo ? url('assets/img/'.$gallery->photo) : url('assets/img/placeholder.png') }}"
                                                    alt="No Image Found">
                                            </a>
                                    </div>
                                @empty
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" id="purchase_price"
