    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class=" mb-0 bc-title"><b>{{ __('Add Testimonial') }}</b> </h3>
			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row justify-content-center">
						<div class="col-lg-8">
								<form class="admin-form" action="{{ route('back.testimonial.store') }}" method="POST">
									...
									<div class="form-group">
										...
										<input type="text" name="client_name" class="form-control" id="client_name"
											placeholder="{{ __('Enter Client Name') }}" value="{{ old('client_name') }}" required>
									</div>
									...
									<div class="form-group">
										...
										<input type="text" name="client_title" class="form-control" id="client_title"
											placeholder="{{ __('e.g., Homeowner, Business Owner, etc.') }}" value="{{ old('client_title') }}" required>
									</div>
